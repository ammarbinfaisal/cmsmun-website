...
class Timer extends PureComponent {
    ...
    render() {
        return (
            <div id="timer" className="s7em questrial" style={{
                position: "absolute",
                top: "4px",
                left: "8px"
            }}>
                <div><span className="numerals">{this.state.daysLeft}</span><span className="text">days</span></div>
                <div><span className="numerals">{this.state.hoursLeft}</span><span className="text">hours</span></div>
                <div><span className="numerals">{this.state.minutesLeft}</span><span className="text">minutes</span></div>
                <div><span className="numerals">{this.state.secondsLeft}</span><span className="text">seconds</span></div>
